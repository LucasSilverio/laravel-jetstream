            ...
            <form method="post" class="w-full max-w-lg" wire:submit.prevent="create">
               ...
               <div class="flex flex-wrap -mx-3 mb-6">
                  <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Jane" wire:model="firstname" name="firstname">
                    @error('firstname')
                        {{ $message }}
                    @enderror
                  </div>
